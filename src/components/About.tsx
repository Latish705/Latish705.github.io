        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-12">
          ...
          <div className="space-y-6 animate-fade-in">
            <p className="text-lg text-white/80">
              I'm Latish Adwani, a passionate Full-Stack Developer and
              Competitive Programmer with a keen interest in building innovative
              web applications and solving complex problems.
            </p>

            <p className="text-lg text-white/80">
              Currently pursuing my Bachelor's degree in Computer Science, I've
              developed a strong foundation in algorithms, data structures, and
              software development. My journey in tech started with competitive
              programming, which honed my problem-solving abilities and coding
              efficiency.
            </p>

            <p className="text-lg text-white/80">
              I'm particularly enthusiastic about creating seamless user
              experiences through modern frontend frameworks, building robust
              backend systems, and deploying applications using cloud services.
