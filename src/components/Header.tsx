    ...
    >
      <div className="container max-w-7xl mx-auto flex justify-between items-center">
        <a href="#home" className="text-white font-bold text-xl">
          <span className="text-purple-500">L</span>atish{" "}
          <span className="text-purple-500">A</span>dwani
        </a>
        ...
        <nav className="hidden md:flex items-center space-x-1">
          ...
          <div className="ml-4 flex items-center space-x-2">
            <a
              href="https://github.com/latish705"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/latish705/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 text-white/70 hover:text-white hover:bg-white/5 rounded-full transition-colors"
              aria-label="LinkedIn"
