        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="w-full md:w-3/5 space-y-8 text-center md:text-left animate-fade-in">
            ...
            <p className="text-white/70 text-lg max-w-2xl">
              ...
              design with powerful functionality. Specializing in full-stack
              development with expertise in React, Java, Cloud services, and
              more.
            </p>
          ...
          >
            <div className="relative">
              ...
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-purple-500/30 animate-scale-in">
                <div className="w-full h-full bg-gradient-to-br from-purple-400 to-purple-700 flex items-center justify-center text-4xl font-bold text-white">
                  LA
                </div>
              </div>
