  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden rounded-lg mb-4">
        <div className={`absolute inset-0 bg-gradient-to-t from-background to-transparent z-10 opacity-40 group-hover:opacity-60 transition-opacity duration-300`}></div>
        <div 
...
const Projects: React.FC = () => {
  const projects: ProjectProps[] = [
    {
      title: 'PlaceNext',
      description: 'A comprehensive platform for college placement management with real-time updates, student profiles, and company integration.',
    ...
    {
      title: 'MedicX',
      description: 'A healthcare app that connects patients with doctors, manages appointments, and provides medication reminders.',
      image: '/placeholder.svg',
      tags: ['React Native', 'Firebase', 'Node.js', 'Redux'],
      liveUrl: '#',
      githubUrl: '#',
    },
    {
      title: 'Research Pilot',
      description: 'An AI-powered research assistant that helps students find relevant papers, summarize content, and discover daily insights.',
      image: '/placeholder.svg',
      tags: ['Python', 'TensorFlow', 'NLP', 'Django'],
      liveUrl: '#',
      githubUrl: '#',
    },
  ];
